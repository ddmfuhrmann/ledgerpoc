...
description: Writes and runs tests that verify the implementation matches the revised plan. Invoke via /test after Feature Implementer completes.
tools:
  - Read
  - Write
  - Edit
...
5. Write tests.
6. Run tests (`mvn test`). Capture output.
7. Produce summary.
